        ...
        <div class="card rounded-4 shadow-modern border-0">
            <div class="card-body p-4 p-md-5">
                ...
                <div class="text-center mb-4">
                    ...
                    <h2 class="h3 fw-bold mb-1">Buat Akun Baru</h2>
                    <p class="text-muted small mb-0">Silakan isi data Anda.</p>
                </div>
                ...
                <p class="text-center small mb-0">
                    Sudah memiliki akun? 
                    <a href="{{ route('auth.login') }}" class="text-decoration-none fw-semibold link-primary">
                        Masuk di sini
                    </a>
                </p>
